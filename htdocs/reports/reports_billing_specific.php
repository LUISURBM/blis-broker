			...
			<div id='report_config_content' style='display:block;'>
				<div id="docbody" name="docbody">
					...
					<div id="report_word_content">
						<?php $align=$report_config->alignment_header;?>
						<h1 align="<?php echo $align=center; ?>"><?php echo $report_config->headerText; ?><?php #echo LangUtil::$pageTerms['MENU_PHISTORY']; ?></h1>
						<h2 align="<?php echo $align; ?>"><?php echo "Patient Bill #" . $bill->getId(); ?></h2>
					</div>
