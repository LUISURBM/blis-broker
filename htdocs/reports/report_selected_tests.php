...
<h2 align="<?php echo $align=center; ?>"><?php echo $report_config->headerText; ?><?php #echo LangUtil::$pageTerms['MENU_PHISTORY']; ?></h2>
<h1 align="<?php echo $align; ?>"><?php echo $report_config->titleText; ?></h1>
</div>
<?php
